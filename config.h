 ...
 */
static const char * const BAR_FONT = "Iosevka Term Medium:size=14";
...
static const char * const BAR_FG_COLOR = "#3993AA";
...
static const int thumb_sizes[] = { 32, 64, 96, 128, 270, 556 };
